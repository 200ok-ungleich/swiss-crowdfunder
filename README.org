...
**** TODO Validierung für Anzahl > 0 Goodies
- [ ] BO: -1 for Infinity
- [X] Validation
- [ ] On goody: Disable button when there's no remaining_quantity

**** TODO Wenn start_date Kampagne nicht erreicht, dann andere Logik: Newsletter Seite.
- [ ] Alternativ: Ausgrauen von CTAs
...
**** TODO As a user, when on campaigns#show, I want to see either when the campaign starts or when it stops in "days remaining"
